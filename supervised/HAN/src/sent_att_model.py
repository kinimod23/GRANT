...
class SentAttNet(nn.Module):
    def __init__(self, sent_hidden_size, word_hidden_size, num_classes, batch_size):
        ...
        self.gru = nn.GRU(2 * word_hidden_size, sent_hidden_size, bidirectional=True, dropout=0.2)
